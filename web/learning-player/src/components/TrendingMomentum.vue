...
const props = defineProps<{
  topics: RisingTopic[]
  /** topic id → { colour, theme label, group } — balloons are coloured by storyline (see TrendingTopics). */
...
<template>
  <div data-testid="trend-momentum">
    ...
    >
      ...
      >
        <circle :cx="b.cx" :cy="b.cy" :r="b.r" :fill="b.color" fill-opacity="0.42" :stroke="b.color" stroke-opacity="0.92" stroke-width="1.5">
