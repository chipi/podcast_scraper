...
import { fetchStorylinesFromApi, fetchTopicClustersFromApi } from '../api/corpusTopicClustersApi'
...
beforeEach(() => {
  ...
  vi.mocked(fetchStorylinesFromApi).mockReset()
  vi.mocked(fetchStorylinesFromApi).mockResolvedValue({ status: 'missing' })
