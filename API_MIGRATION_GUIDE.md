...
### 🔧 **Accessing Internal Functions (Advanced Use)**

The public API is minimal by design. If you need internal functions (e.g., for testing or advanced usage), import from specific modules:
...
**Note:** Internal APIs may change between minor versions. The public API (Config, load_config_file, run_pipeline, cli) is stable.
...
For questions or issues, see the README.md file.
