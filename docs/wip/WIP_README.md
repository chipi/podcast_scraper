...
| ---- | ----------- | ------ |
| `RFC097_FOLLOWUPS_HANDOFF.md` | Session-handoff for `feat/rfc097-followups` branch. **2026-06-23 update:** #1060 closed in this branch — D1=B (YAML-only first-class doc-only path landed in `config/profiles/README.md` + registry docstring), D2=A (summllama_3_2_3b_paragraph StageOption shipped, fresh smoke_v2 measurement: ROUGE-L 0.251 / cosine 0.823 / 53s/ep MPS), D3=A (tiny.en + medium.en transcription + bart-small+long-fast summary StageOptions shipped, smoke_v2 benchmark in `docs/guides/eval-reports/EVAL_DEV_TIER_REGISTRY_2026_06_23.md`). 3 ProfilePresets promoted: airgapped, airgapped_thin, dev. Viewer chain (#1048/#1049/#1050) still active. | Active |
