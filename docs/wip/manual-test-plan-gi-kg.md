...
| **Shallow v1 scope (what ships vs deferred)** | GIL: [Recorded product decisions (v1, issue 460)](../guides/GROUNDED_INSIGHTS_GUIDE.md#recorded-product-decisions-v1-issue-460); KG: [Recorded product decisions (v1, KG shallow)](../guides/KNOWLEDGE_GRAPH_GUIDE.md#recorded-product-decisions-v1-kg); WIP: [gi-kg-shallow-v1-vs-full-depth.md](gi-kg-shallow-v1-vs-full-depth.md) |
