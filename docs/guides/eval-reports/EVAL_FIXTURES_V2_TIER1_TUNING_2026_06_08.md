...
All three classes contributed to `docs/rfc/RFC-116-autoresearch-driven-fixture-corpus.md` for #921.
...
Two new entries appended to `docs/rfc/RFC-116-autoresearch-driven-fixture-corpus.md`:
