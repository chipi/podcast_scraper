...
(`docs/rfc/RFC-110-autoresearch-driven-fixture-corpus.md`). Each prod-observed failure mode is
...
* **Spec input:** `docs/rfc/RFC-110-autoresearch-driven-fixture-corpus.md` (each section
