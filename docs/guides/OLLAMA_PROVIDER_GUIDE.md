...
- [ ] **Eval configs (`data/eval/configs/`):** **`llm_ollama_*_smoke_v1`** = pure Ollama summarization (no LongT5; same shape as `llm_mistral_smoke_v1`). Mistral-family Ollama smokes include `llm_ollama_mistral_7b_smoke_v1`, `llm_ollama_mistral_nemo_12b_smoke_v1`, `llm_ollama_mistral_small3_2_smoke_v1`. **`hybrid_ml_tier2_*`** = LongT5 MAP + Ollama REDUCE (needs HF MAP cache + `ollama pull`). Qwen 3.5 tier extras: `hybrid_ml_tier2_qwen35_*b_authority_v1`, `hybrid_ml_tier2_qwen35_9b_smoke_tuned_v1`, `hybrid_ml_tier2_qwen35_9b_smoke_paragraph_v1`.
