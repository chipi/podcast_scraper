...
| Feed-level disk cache vs conditional GET cache | Eval materialization — [EXPERIMENT_GUIDE](https://evals.tail6d0ed4.ts.net/guides/EXPERIMENT_GUIDE/) |
...
- **Metrics:** Stage timings **`scraping`** and **`parsing`**; download-resilience counters in
  **`metrics.json`** (see [Experiment Guide](https://evals.tail6d0ed4.ts.net/guides/EXPERIMENT_GUIDE/#pipeline-run-metrics-download-resilience)).
