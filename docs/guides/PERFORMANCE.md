...
For **frozen release profiles** (YAML under `data/profiles/`, `make profile-freeze` / `make profile-diff`), see the **Performance Profile Guide (moved to the private eval repo)** (RFC-064).
