...
6. **Implementation**: Code is written following the approved RFC and ADRs, and against any linked UXS for UI surfaces. For the **GI/KG viewer**, follow the **UX + E2E workflow** in the [E2E Testing Guide](E2E_TESTING_GUIDE.md#when-you-change-viewer-ux-required-workflow): update the [E2E surface map](https://github.com/chipi/podcast_scraper/blob/main/web/gi-kg-viewer/e2e/E2E_SURFACE_MAP.md), Playwright specs/helpers, and [UXS-001](../uxs/UXS-001-gi-kg-viewer.md) when the visual contract changes ([GitHub #509](https://github.com/chipi/podcast_scraper/issues/509)).
