...
only speaker-count bounds, and coarsening trades split-fixes for merge-regressions (ADR-132 §Q2).

## Related Documentation

- [ADR-132: Provider-specific speaker labeling](../adr/ADR-132-provider-specific-speaker-labeling.md) - Why diarization providers need a labeling strategy
