...
**Validated by:** [EVAL_SUMMARY_MODEL_RELIABILITY_2026_06_08.md](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_SUMMARY_MODEL_RELIABILITY_2026_06_08/) (#816, 2026-06-08).
...
| Speaker-detector | Gemini | `speaker_detector_provider: gemini` | Cloud kept — Ollama-on-DGX measured at 80s/call (vs Gemini 0.6s/call) at the same accuracy floor; the 133× latency penalty disqualifies DGX for this stage. spaCy is 17× worse on the production-relevant metric (faithful guest extraction from RSS metadata). See [EVAL_SPEAKER_DETECTION_NAMING_2026_06_15.md](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_SPEAKER_DETECTION_NAMING_2026_06_15/). |

**Validated by:**

- [EVAL_HYBRID_ROUTING_2026_06.md](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_HYBRID_ROUTING_2026_06/) — #931 synthesis, profile-defaults decision.
- [EVAL_TRANSCRIPTION_3WAY_2026_06.md](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_TRANSCRIPTION_3WAY_2026_06/) — #929 transcription championship.
- [EVAL_DIARIZATION_DGX_VS_CLOUD_2026_06.md](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_DIARIZATION_DGX_VS_CLOUD_2026_06/) — #930 diarization championship.
- [EVAL_SUMMARY_DGX_LOCAL_2026_06.md](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_SUMMARY_DGX_LOCAL_2026_06/) — #928 Cell C summary parity.
- [EVAL_SPEAKER_DETECTION_NAMING_2026_06_15.md](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_SPEAKER_DETECTION_NAMING_2026_06_15/) — #997 speaker-detector bake-off (Gemini vs spaCy vs Ollama on DGX).
- [EVAL_WHISPER_CONTENTION_2026_06.md](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_WHISPER_CONTENTION_2026_06/) — #963 contention re-tests (2026-06-11 + 2026-06-14).
