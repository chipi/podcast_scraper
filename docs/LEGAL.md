...
Using this software privately on your local device or server, you may:

- download publicly available podcast metadata

- cache audio files for personal listening

- generate summaries or embeddings for private research

- analyze episodes as part of personal study or experimentation

- store data locally without sharing it

These actions are generally considered low-risk and comparable to typical usage of podcast applications.
