...
- **`metrics.json`:** `http_urllib3_retry_events`, `episode_download_retries`, `episode_download_retry_sleep_seconds` for triage ([Experiment Guide -- Pipeline run metrics](../guides/EXPERIMENT_GUIDE.md#pipeline-run-metrics-download-resilience)).
...
- [Experiment Guide](../guides/EXPERIMENT_GUIDE.md) -- pipeline `metrics.json` and download-resilience fields (Step 4)
