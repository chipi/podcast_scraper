...
infra/edge programme (shared Caddy edge, secrets, privilege-split, observability, Cloudflare). From the index table: **3** **Proposed** (**ADR-055** tied to Draft
RFC-053, plus **ADR-109/111**; the infra programme **ADR-114–118** is Accepted; ADR-104 was promoted to Accepted with RFC-088 chunk 8, and ADR-110 was promoted to Accepted — shipped default-on this branch), **3** **Superseded** (**ADR-056**,
