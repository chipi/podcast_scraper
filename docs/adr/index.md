...
infra/edge programme (shared Caddy edge, secrets, privilege-split, observability, Cloudflare). From the index table: **4** **Proposed** (**ADR-055** tied to Draft
RFC-053, plus **ADR-109/110/111**; the infra programme **ADR-114–118** is Accepted; ADR-104 was promoted to Accepted with RFC-088 chunk 8), **3** **Superseded** (**ADR-056**,
