...
| [ADR-108](ADR-108-nli-disagreement-enrichers-gated-dark.md) | NLI-based disagreement enrichers gated dark | Accepted | [RFC-088](../rfc/RFC-088-enrichment-layer-architecture.md) | `nli_contradiction` (#1106) + `stance_disagreement` (#1144) measured 0% precision; both gated dark by the data-driven accuracy gate. The live cross-speaker surface is `perspectives` (#1146), a CIL query, not an enricher. | Dark (gated) |
