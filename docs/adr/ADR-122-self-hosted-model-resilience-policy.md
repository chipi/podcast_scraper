...
(see [ADR-143](ADR-146-corpus-reprocess-methodology.md), #1178/#1179), a **transient GPU contention** (a
...
- [ADR-143](ADR-146-corpus-reprocess-methodology.md) — the reprocess methodology this serves.
