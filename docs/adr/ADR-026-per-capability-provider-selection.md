...
- [ADR-024: Unified Provider Pattern](ADR-024-unified-provider-pattern.md) – Type-based unified provider classes
- [ADR-020: Protocol-Based Provider Discovery](ADR-020-protocol-based-provider-discovery.md) – PEP 544 Protocols per capability
