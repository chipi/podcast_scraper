...
This installs only the core dependencies required for basic transcript downloading functionality.
...
This installs all dependencies including ML libraries for transcription and summarization features.
