...
Currently, `__api_version__` matches `__version__`. In the future, these may diverge if internal changes don't affect the public API.
...
For more fine-grained checking:
...
- [API Migration Guide](API_MIGRATION_GUIDE.md) - Version-specific migrations
...
1. Check [API Boundaries](API_BOUNDARIES.md) for public vs internal API
2. Review [API Migration Guide](API_MIGRATION_GUIDE.md) for version changes
3. Open an issue on GitHub

## Related

- [API Boundaries](API_BOUNDARIES.md) - What's public vs internal
- [API Migration Guide](API_MIGRATION_GUIDE.md) - Upgrading between versions
