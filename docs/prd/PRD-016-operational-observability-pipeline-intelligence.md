...
- **Related RFCs**:
  ...
  - `RFC-064` (moved to the private eval repo as RFC-008) — frozen release profiles + diff tooling (**complete**)
  - [RFC-065](../rfc/RFC-065-live-pipeline-monitor.md) — live pipeline monitor (**complete**; tmux split deferred)
  - `RFC-066` (moved to the private eval repo as RFC-009) — Streamlit compare **Performance** tab (**complete**)
