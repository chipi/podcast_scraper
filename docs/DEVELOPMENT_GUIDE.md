...
For detailed information about markdown linting, including automated fixing, table formatting solutions, pre-commit hooks, and CI/CD integration, see the [Markdown Linting Guide](MARKDOWN_LINTING.md).
...
For detailed information about third-party dependencies, including rationale for selection, alternatives considered, and dependency management philosophy, see the [Dependencies Guide](DEPENDENCIES.md).
