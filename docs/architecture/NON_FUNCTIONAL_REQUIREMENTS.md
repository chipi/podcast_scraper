...
| **Vector search scale** | Embedded **LanceDB** hybrid backend (BM25 + dense + RRF) is the sole search backend at v2.7+ ([RFC-090](../rfc/RFC-090-hybrid-retrieval.md)); the legacy FAISS store was retired (ADR-099 / #995); remote backends remain future ([RFC-070](../rfc/RFC-070-semantic-corpus-search-platform-future.md), Draft). | Met (LanceDB hybrid) | [RFC-090](../rfc/RFC-090-hybrid-retrieval.md), [RFC-061](../rfc/RFC-061-semantic-corpus-search.md), [RFC-070](../rfc/RFC-070-semantic-corpus-search-platform-future.md) |
