...
| **Server API latency** | Viewer API endpoints (`/api/*`) respond within 500 ms for typical corpus sizes (≤ 500 episodes). Corpus search queries (hybrid or FAISS) return within 2 s including embedding. | Met | [RFC-062](../rfc/RFC-062-gi-kg-viewer-v2.md), [RFC-090](../rfc/RFC-090-hybrid-retrieval.md), [RFC-061](../rfc/RFC-061-semantic-corpus-search.md) |
...
| **Vector search scale** | Embedded **LanceDB** hybrid backend (BM25 + dense + RRF) is the default at v2.7+ ([RFC-090](../rfc/RFC-090-hybrid-retrieval.md)); FAISS (flat / auto IVF / IVFPQ) retained as a CLI-scale fallback; remote backends remain future ([RFC-070](../rfc/RFC-070-semantic-corpus-search-platform-future.md), Draft). | Met (hybrid + FAISS) | [RFC-090](../rfc/RFC-090-hybrid-retrieval.md), [RFC-061](../rfc/RFC-061-semantic-corpus-search.md), [RFC-070](../rfc/RFC-070-semantic-corpus-search-platform-future.md) |
