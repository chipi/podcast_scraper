...
- **2 ML — gated dark**: `nli_contradiction` + `stance_disagreement` (cross-Person contradiction / stance disagreement). Both measured **0% precision** (#1106 / #1144) and are excluded by the accuracy gate below — wired but never run. See [ADR-108](../adr/ADR-108-nli-disagreement-enrichers-gated-dark.md).
