...
- **Update (2026-07-11, #1170)**: the default pipeline was promoted from `speaker-diarization-3.1` to `speaker-diarization-community-1` (v4) — it beats 3.1 on the full v3 fixture set (count 40/45, DER 7.1%) and is non-gated. 3.1 is now the registry fallback. Historical `3.1` snippets below are preserved as the original design. See [`EVAL_DIARIZATION_31_VS_COMMUNITY1_RTTM_2026_07`](https://evals.tail6d0ed4.ts.net/guides/eval-reports/EVAL_DIARIZATION_31_VS_COMMUNITY1_RTTM_2026_07/).
