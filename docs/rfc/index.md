...
| [RFC-079](RFC-079-full-stack-docker-compose.md) | Full-stack Compose (Nginx + API + pipeline) | **Draft:** `compose/docker-compose.stack.yml`, `stack-*`, [#659](https://github.com/chipi/podcast_scraper/issues/659) Phase 1 (closed) + [#660](https://github.com/chipi/podcast_scraper/issues/660) Docker job path; [§Native vs Docker](RFC-079-full-stack-docker-compose.md#native-vs-docker) |
