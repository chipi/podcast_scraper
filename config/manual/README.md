...
- **Canonical file:** [`../grafana/dashboards/common/grafana-dashboard-pipeline-execution.json`](../grafana/dashboards/common/grafana-dashboard-pipeline-execution.json)
