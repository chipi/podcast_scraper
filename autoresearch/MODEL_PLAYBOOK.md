...
| DeepSeek-V2-Lite-Chat | 31.4 GB BF16 | 0.55 | 32768 | 4096 | no | none | `vllm/strict_summarization/*` (avoid transcript echo) | **`decode_r1_byte_level` REQUIRED** | ✓ working with strict + postproc — **fastest DGX (4.8s/ep)** |
