...
Usage:
    python scripts/analyze_test_memory.py [--test-target TARGET] [--max-workers N]

Examples:
    # Analyze default test target
    python scripts/analyze_test_memory.py

    # Analyze with limited workers
    python scripts/analyze_test_memory.py --max-workers 4
