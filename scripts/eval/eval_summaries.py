...
Usage:
    ...
    python scripts/eval/eval_summaries.py --output data/results/my_evaluation.json

    # Specify MAP model only (REDUCE defaults to LED)
    python scripts/eval/eval_summaries.py --map-model bart-large
    ...
    python scripts/eval/eval_summaries.py --config config.yaml

    # Use short reference summaries
    python scripts/eval/eval_summaries.py --use-short-reference
"""
