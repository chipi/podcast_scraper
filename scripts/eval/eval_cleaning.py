...
Usage:
    ...
    python scripts/eval/eval_cleaning.py --output data/results/cleaning_eval.json
    python scripts/eval/eval_cleaning.py --episode ep01  # Evaluate single episode
"""
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Output JSON file path (default: data/results/cleaning_eval_<timestamp>.json)",
    )
    parser.add_argument(
        "--log-level",
        type=str,
