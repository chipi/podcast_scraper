...
Examples:
  ...
  python scripts/cache/restore_cache.py
  ...
  python scripts/cache/restore_cache.py --backup 20250108

  # Dry run to see what would be restored
  python scripts/cache/restore_cache.py --backup 20250108 --dry-run
  ...
  python scripts/cache/restore_cache.py --backup-dir ~/my_backups --backup 20250108
        """,
    )
    parser.add_argument(
        "--backup-dir",
