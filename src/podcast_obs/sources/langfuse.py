...
Complements the cost/error sources: where the VictoriaLogs ``llm_cost`` events answer "how much
did we spend", Langfuse answers "what did each LLM call *do*" (model / token usage / cost per
