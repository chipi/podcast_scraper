...
# Use constant from config_constants for consistency with other cache directories
PREPROCESSING_CACHE_DIR = config_constants.DEFAULT_PREPROCESSING_CACHE_DIR
