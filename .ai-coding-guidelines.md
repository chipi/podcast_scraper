...
**All analysis or plan documents MUST be created in `docs/wip/` folder:**

- ✅ **Analysis documents** (code analysis, test pyramid analysis, performance analysis, etc.)
- ✅ **Plan documents** (implementation plans, refactoring plans, migration plans, etc.)
- ✅ **Work-in-progress documentation** (draft RFCs, experimental designs, etc.)
- ✅ **Review documents** (code reviews, architecture reviews, etc.)
...
**Do NOT create analysis/plan documents in:**
...
- `docs/guides/MD_STYLE_REFERENCE.md` - **Short markdown style contract for Cursor** (concise rules)
