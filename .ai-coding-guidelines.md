...
- **`[dev]`** is the only extra installed by CI `test-unit`. Any test that needs FastAPI, httpx,
  torch, spaCy, faiss, etc. belongs in **`tests/integration/`** (where CI installs
  `.[dev,ml,llm]`).
...
- Do **not** use real **`FaissVectorStore`** builds, real Whisper / spaCy, or real HTTP clients
  in unit tests.
...
- **[docs/DEVELOPMENT_GUIDE.md](docs/DEVELOPMENT_GUIDE.md)** - ** Detailed technical information** (code style, testing, CI/CD, architecture, logging, documentation standards, markdown linting)
...
- Code style details → See `docs/DEVELOPMENT_GUIDE.md` (Code Style Guidelines section)
- Testing details → See `docs/DEVELOPMENT_GUIDE.md` (Testing Requirements section)
- CI/CD details → See `docs/DEVELOPMENT_GUIDE.md` (CI/CD Integration section)
- Architecture patterns → See `docs/DEVELOPMENT_GUIDE.md` (Architecture Principles section)
- Logging patterns → See `docs/DEVELOPMENT_GUIDE.md` (Logging Guidelines section)
- Documentation standards → See `docs/DEVELOPMENT_GUIDE.md` (Documentation Standards section)
