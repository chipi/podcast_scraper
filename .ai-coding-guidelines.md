...
```text
- Run `make ci-fast` before committing (pre-commit hook will also run this)
...
1. ✅ Make code changes
2. ✅ **MANDATORY: Run `make ci-fast`** - Fast validation before committing (formatting, linting, fast tests)
