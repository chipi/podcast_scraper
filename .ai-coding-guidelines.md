...
**Guides:** `docs/guides/E2E_TESTING_GUIDE.md` (Playwright), `docs/guides/TESTING_GUIDE.md` (*Browser E2E*), `docs/guides/DEVELOPMENT_GUIDE.md` (GI/KG viewer), `docs/guides/SERVER_GUIDE.md` (`/api/*`, OpenAPI `/docs`), `docs/uxs/index.md`.
