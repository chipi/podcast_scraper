...
**On every push to PR (4 parallel jobs):**

1. **Lint Job** (2-3 min, fast feedback):
...
- Read docs/CI_CD.md for CI/CD pipeline details (includes path-based filtering optimization)
- Run `make ci` to validate changes

---

**Version:** 1.1 (matches v2.3.0 + pre-commit hooks + CI/CD docs)  
