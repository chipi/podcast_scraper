...
1. ✅ Make code changes
2. ✅ Show user what files changed (`git status` or `git diff`)
3. ✅ Show user the actual changes (`git diff` for modified files)
4. ✅ Wait for explicit user approval before committing
5. ✅ Let user decide commit message and timing
