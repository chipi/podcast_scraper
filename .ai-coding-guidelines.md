...
3. ✅ **MANDATORY: Run `git diff`** - Show user the actual changes (for each modified file)
4. ✅ **MANDATORY: Wait for explicit user approval** - User must explicitly say "commit", "yes", "go ahead", etc.
5. ✅ **MANDATORY: Get commit message** - User provides message OR you ask "What commit message should I use?"
...
5. ✅ Run `make format` and `make test` before committing (if no hook)
