"""Integration tests for Grok providers.
...
pytestmark = [pytest.mark.integration, pytest.mark.module_grok_providers]
...
class TestGrokSpeakerDetector(unittest.TestCase):
    ...
    def test_provider_initialization(self, mock_openai_class):
        ...
        # Verify client was created with API key and Grok base URL
    ...
    @patch(
        "podcast_scraper.providers.grok.grok_provider.GrokProvider._build_speaker_detection_prompt"
    )
    @patch(
        "podcast_scraper.providers.grok.grok_provider.GrokProvider._parse_speakers_from_response"
    )
    ...
    def test_factory_creates_grok_detector(self):
        """Test that factory creates unified Grok provider."""
        detector = create_speaker_detector(self.cfg)
...
class TestGrokSummarizationProvider(unittest.TestCase):
    ...
    @patch("podcast_scraper.providers.grok.grok_provider.GrokProvider._build_summarization_prompts")
...
class TestGrokProviderErrorHandling(unittest.TestCase):
    """Test error handling for Grok providers."""
    ...
    def test_detect_speakers_api_error(self, mock_render_prompt, mock_openai_class):
        ...
        self.assertIn("Grok speaker detection failed", str(cm.exception))
