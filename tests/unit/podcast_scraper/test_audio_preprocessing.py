...
class TestFFmpegAudioPreprocessor(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.fixture_audio = (
            Path(__file__).parent.parent.parent.parent / "fixtures" / "audio" / "p01_e01_fast.mp3"
        )
    ...
    @unittest.skipUnless(
        ...
        "FFmpeg not available or fixture file missing",
    )
...
class TestFactory(unittest.TestCase):
    ...
    @patch("podcast_scraper.audio_preprocessing.ffmpeg_processor._check_ffmpeg_available")
