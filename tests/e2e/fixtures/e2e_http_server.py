...
class E2EHTTPRequestHandler(http.server.SimpleHTTPRequestHandler):
    ...
    PODCAST_RSS_MAP = {
        ...
        # --- corpus feeds (2026-08-16) ---
        # One feed per show describing the WHOLE app-validation corpus, generated by
        # scripts/build_corpus_feeds.py from transcripts + audio. The fixtures above are an e2e
