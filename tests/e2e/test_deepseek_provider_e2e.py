...
class TestDeepSeekProviderE2E:
    ...
    def test_deepseek_hybrid_cleaning_strategy(self, e2e_server: Optional[Any]):
        """Test DeepSeek provider with hybrid cleaning strategy (pattern + conditional LLM).
        ...
        try:
            ...
            # Create config with DeepSeek summarization and hybrid cleaning strategy
            # Note: DeepSeek does NOT support transcription, so we use Whisper
            config_kwargs = {
                "rss_url": rss_url,
                "output_dir": temp_dir,
                "transcription_provider": "whisper",  # DeepSeek doesn't support transcription
                "speaker_detector_provider": "deepseek",
                "summary_provider": "deepseek",
            ...
            _save_all_episode_responses(
                Path(temp_dir),
                metadata_files,
                "test_deepseek_hybrid_cleaning_strategy",
                validate_provider="deepseek",
