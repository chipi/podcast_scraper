...
from podcast_scraper import Config, config, service


@pytest.mark.e2e
class TestServiceAPIBasic:
    """Basic Service API E2E tests."""

    @pytest.mark.slow
    def test_service_run_basic(self, e2e_server):
        """Test service.run() with basic config.
    ...
    @pytest.mark.slow
    def test_service_run_with_metadata(self, e2e_server):
        """Test service.run() with metadata generation.
    ...
    @pytest.mark.slow
    def test_service_run_with_summaries(self, e2e_server):
        """Test service.run() with summarization.

        This test is marked as slow because it tests an extended feature
        (summarization) that takes significant time (~275s).
    ...
    @pytest.mark.slow
    def test_service_run_all_features(self, e2e_server):
        """Test service.run() with all features enabled.
